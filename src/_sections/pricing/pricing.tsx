      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex flex-row items-center gap-12">
          <div className="flex-shrink-0">
            <iframe
              className="mr-10 aspect-video rounded-lg ring-12 ring-purple-200"
              width="560"
              height="315"
          ...
          <div className="font-bold flex-1 flex flex-col justify-center">
            <p className="text-2xl text-white leading-snug mb-4">
              ...
              Visualize jogadores através de paredes, identifique itens valiosos e elimine o fator surpresa do seu gameplay.
            </p>
